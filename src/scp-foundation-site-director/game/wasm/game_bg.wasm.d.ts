...
export function setRealityEvents(a: number, b: number): void;
...
export function closure1988_externref_shim(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h0ba33058bb154c39(a: number, b: number): void;
export function closure2117_externref_shim(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__he4ee1c703a3bc044(a: number, b: number): void;
export function closure53510_externref_shim(a: number, b: number, c: number): void;
