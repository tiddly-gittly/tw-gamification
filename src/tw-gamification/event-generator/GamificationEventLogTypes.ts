import { IDuplicationStrategy, IGamificationEvent } from './GamificationEventTypes';
...
export interface IAddGamificationEventParameterObjectFromJS {
  events: Array<IGameEventLogCacheItem & IDuplicationStrategy>;
}
/**
 * A flattened object of `IGameEventLogCacheItem`. Add one event at a time.
 */
export interface IAddGamificationEventParameterObjectFromActionWidget extends IGamificationEvent, IDuplicationStrategy {
  /**
