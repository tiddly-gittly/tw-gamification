 ...
 */
export enum BasicRealityEventTypes {
  Item = 'Item',
  LargePunishment = 'LargePunishment',
  LargeReward = 'LargeReward',
  SmallPunishment = 'SmallPunishment',
  /** Default to `BasicRealityEventTypes.SmallReward` */
  SmallReward = 'SmallReward',
}

export interface IRealityEvent {
  /**
   ...
   * Only used when event is `BasicRealityEventTypes.Item`
   */
  item?: string;
  /**
